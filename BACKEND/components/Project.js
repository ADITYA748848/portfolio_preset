...
export default function Project( 
    ...
    const [client, setclient] = useState(existingclinet || '');
    ...
    return <>
        <form className='addWebsiteform' onSubmit={createBlog}>
            ...
            <div className="w-100 flex flex-col flex-left mb-2">
                <label htmlFor="livepreview">Livepreview</label>
                <input
                    type="text"
                    id='livepreview'
            ...
            <div className="w-100 flex flex-col flex-left mb-2">
                ...
                <select onChange={(e) => setprojectcategory(Array.from(e.target.selectedOptions, option => option.value))} value={projectcategory} name="project" id="project" multiple>

          ...
          <div className="container">
            <div className="toptitle ">
              <div className="toptitlecont flex">
                <h1>
                  Welcome to <span>Aditya Blogs!</span>
                </h1>
                <p>
                  I Write about web, mobile development and modern JavaScript
                  frameworks. The best article, links and news related to web
                      ...
                      return (
                        <div className="lpost" key={blog._id}>
                          ...
                          <div className="lpostinfo">
                            ...
                            <p>Audio equidem philosophi vocem, Epicure, sed quid tibi dicendum sit oblitus es. Haec et tu ita posuisti, et</p>
                            <h4 className="flex"><img src="/img/coder.jpg" alt="" /><span>by Aditya coder</span></h4>
                          </div>
                        </div>
                      );
                    })}

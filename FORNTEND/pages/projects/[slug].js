            ...
            return (
                <div style={{ position: 'relative' }}>
                    <SyntaxHighlighter
                        ...
                        codeTagProps={{
                            style: {
                                padding: '0', borderRadius: '5px',
                                overflow: 'auto', whiteSpace: 'pre-warp'
                            }
                        }}>
                ...
                <div className="container">
                    ...
                    <div className="projectsluginfo">
                        <div className="leftmainproinfo">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos asperiores
                                ratione esse, impedit ullam tenetur neque saepe ipsum maxime, vel omnis officiis dolorem
                                error unde!</p>
                        ...
                        <div className="rightmainproinfo">
                            ...
                            <div>
                                <h3>Start Date</h3>
                                <h2>{formateDate(createdAtDate)}</h2>
                            </div>
                            <div>
                                <h3>Designer</h3>
                                <h2>Aditya RAj</h2>
